 ...
 */
public class ChooseJiGongAdapter extends RecyclerView.Adapter<ChooseJiGongAdapter.ViewHolder> {
    private List<JiGong.JigongsEntity> bean;
    private LayoutInflater layoutInflater;
    private Context mContext;

    public ChooseJiGongAdapter(Context context, List<JiGong.JigongsEntity> bean) {
        this.bean = bean;
    ...
    public ChooseJiGongAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
