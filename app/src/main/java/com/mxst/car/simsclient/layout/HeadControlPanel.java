...
public class HeadControlPanel extends RelativeLayout {
    ...
    private midTitleOnClickListener mListener;
    ...
    protected void onFinishInflate() {
        ...
        mMidleTitle.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.mTitleClick();
            }
        });
    }
    ...
    public interface midTitleOnClickListener {
        void mTitleClick();
    }

    public void setMiddleTitleClick(midTitleOnClickListener listener) {
